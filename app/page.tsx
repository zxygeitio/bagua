...
import { ArrowRight, Earth, Fire, Metal, Star, Water, Wood, Wand } from '@/components/icons'
              ...
              <Reveal key={tag} delay={i * 80} direction="up">
                ...
                >
                  <Icon
                    ...
                    strokeWidth={1.5}
                  />
                  <div className="font-display text-2xl tracking-widest text-bagua-text">{tag}</div>
                  <div className="my-1">
