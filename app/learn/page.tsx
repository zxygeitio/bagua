  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8 md:px-6 md:py-12">
      ...
      <Section
        index="01.5"
        title="六十四卦曼陀罗"
        intro="按上卦分八区，每区八卦。悬停查看卦名，点击进入全文。"
      >
      ...
      <Section
        index="01.6"
        title="卦序结构"
        intro="六十四卦为何这样排序？文王序两两成对（综卦 / 错卦），八卦自先天位可读出二进制。"
      >
        <Link
          href="/learn/order"
        ...
        >
          <span className="prose-body text-sm text-bagua-text">
            查看<span className="font-display text-bagua-primary">卦序结构</span>
            ：32 对配对结构、先天八卦二进制与六十四卦编码总表。
          </span>
          <span
            aria-hidden="true"
